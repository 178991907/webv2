...
export function MainHeader({ settings }: { settings: Settings }) {
  return (
    <header className="py-6 sm:py-8 md:py-12 text-center relative">
      <div className="absolute top-3 right-3 sm:top-4 sm:right-4 flex flex-col sm:flex-row items-end sm:items-center gap-1 sm:gap-2">
      ...
      <div className="container mx-auto px-4 pt-8 sm:pt-4">
        ...
        <h1
          ...
          className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight bg-clip-text text-transparent animate-gradient"
        >
          {settings.title}
        </h1>
        <p
        ...
        <p
          ...
          className="mt-2 sm:mt-4 text-sm sm:text-base md:text-xl lg:text-2xl max-w-2xl mx-auto bg-clip-text text-transparent animate-gradient px-4"
        >
