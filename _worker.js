/**
 * 英语全科启蒙导航 - Cloudflare Worker v3.0.3
 * 特性：7 儿童友好主题 (薄荷/薰衣草/柠檬/棉花糖/海洋/银河/极致纯黑)
 *       大号卡片 Logo (64px)、Tooltip 布局偏移、聚光灯聚焦、本地主题持久化
 *       v3.0.3 优化：修复浅色主题下 Tooltip 文字对比度问题 (使用 !important)
 */
...
const CSS_BUNDLE = `
  ...
  /* Tooltip 样式 - v3.0.3 优化: 强制暗色模式以确保清晰度 */
  .card-tooltip {
    position: absolute;
    right: -210px;
    top: 0;
    width: 200px;
    background: #1e1b4b !important; /* 强制使用深色背景 (银河主题色) */
...
<body class="bg-slate-50 font-sans">
    <div class="flex min-h-screen">
        ...
        <aside class="w-72 bg-white border-r border-slate-200 p-8 flex flex-col pt-12">
            ...
            <p class="text-xs text-slate-400 mb-12">v3.0.3 - 儿童友好版</p>
